...
public class EnemyShip extends Entity {
	...
	public final void destroy() {
		...
		if(this.spriteType == spriteType.EnemyShipA1)
			this.spriteType = spriteType.EnemyShipA1;
		else if(this.spriteType == spriteType.EnemyShipA2)
			this.spriteType = spriteType.EnemyShipA2;
		else if(this.spriteType == spriteType.EnemyShipB1)
			this.spriteType = spriteType.EnemyShipB1;
		else if(this.spriteType == spriteType.EnemyShipB2)
			this.spriteType = spriteType.EnemyShipB2;
		else if(this.spriteType == spriteType.EnemyShipC1)
			this.spriteType = spriteType.EnemyShipC1;
		else
			this.spriteType = spriteType.EnemyShipC2;
